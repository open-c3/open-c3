...
post '/config' => sub {
    ...
    if( $config->{frontendstyle} && $config->{frontendstyle} eq 'juyun' )
    {
        ...
        system "sed -i 's/#f63/#3b3677/g' $BASE_PATH/scripts/*";
    ...
    else
    {
        ...
        system "sed -i 's/#3b3677/#f63/g' $BASE_PATH/scripts/*";
    ...
    {
        system "sed -i 's#openc3_monitor_monagent9100=1#openc3_monitor_monagent9100=0#g' $BASE_PATH/scripts/*";
    }
