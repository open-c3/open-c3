...
# 查询子网列表
echo '{"account": "example-account", "region": "ap-beijing", "vpc_id": "vpc-a21s8kcg"}' | c3mc-qcloud-cvm-describe-subnets | c3mc-bpm-display-field-values SubnetId,SubnetName,AvailableIpAddressCount
# 查询安全组列表
echo '{"account": "example-account", "region": "ap-beijing", "project_id": 1176270}' | c3mc-qcloud-cvm-describe-security-groups | c3mc-bpm-display-field-values SecurityGroupId,SecurityGroupName
# 查询实例付费方式列表
c3mc-qcloud-cvm-describe-instance-charge-type-list | c3mc-bpm-display-field-values id,name
# 查询自动续费标识列表
c3mc-qcloud-cvm-describe-renew-flag-list | c3mc-bpm-display-field-values id,name
# 查询网络计费类型列表
c3mc-qcloud-cvm-describe-internet-charge-type-list | c3mc-bpm-display-field-values id,name
