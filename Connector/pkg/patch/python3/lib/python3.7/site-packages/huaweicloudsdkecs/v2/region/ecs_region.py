...
class EcsRegion:
    ...
    AF_NORTH_1 = Region(id="af-north-1", endpoint="https://ecs.af-north-1.myhuaweicloud.com")

    AP_SOUTHEAST_4 = Region(id="ap-southeast-4", endpoint="https://ecs.ap-southeast-4.myhuaweicloud.com")

    EU_WEST_101 = Region(id="eu-west-101", endpoint="https://ecs.eu-west-101.myhuaweicloud.eu")
