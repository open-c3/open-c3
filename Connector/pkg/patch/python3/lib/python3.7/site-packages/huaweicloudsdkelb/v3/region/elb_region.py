...
class ElbRegion:
    ...
    AP_SOUTHEAST_4 = Region(id="ap-southeast-4", endpoint="https://elb.ap-southeast-4.myhuaweicloud.com")

    EU_WEST_101 = Region(id="eu-west-101", endpoint="https://elb.eu-west-101.myhuaweicloud.eu")
