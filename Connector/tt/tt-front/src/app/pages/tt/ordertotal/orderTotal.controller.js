(function () {
  ...
  angular
    .module('cmdb')
    .controller('OrderTotalController', OrderTotalController);

  /** @ngInject */
  function OrderTotalController ($state, $http, $location, baseService, NgTableParams, toastr) {
    ...
    vm.search = function () {
      ...
      $http.get('/api/tt/statistics/get_tts' + '?start=' + start + '&end=' + end +  keyword).success(function (data) {
        if (data.code === 200) {
          vm.loading = false
