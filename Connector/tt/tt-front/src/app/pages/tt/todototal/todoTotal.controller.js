(function () {
  ...
  angular
    .module('cmdb')
    .controller('TodoTotalController', TodoTotalController);

  /** @ngInject */
  function TodoTotalController ($http, $location, baseService, NgTableParams, toastr) {
    ...
    vm.search = function () {
      ...
      $http.get('/api/tt/statistics/get_todo_tts' + '?start=' + start + '&end=' + end + '&all=' + 1 + keyword).success(function (data) {
        if (data.code === 200) {
          vm.loading = false;
