    ...
    function cmnavbar() {
        ...
        function NavbarController($scope, $location, $http, $state, treeService, $window, ssoService) {
            ...
            vm.zTree = '';
              ...
              vm.search_init = function () {
                vm.names = [];
                $http.get('/api/connector/connectorx/treemapxxx111').success(function (data) {
                  vm.name = data.data;
       ...
       //       vm.search_init(event)
            ...
            vm.logout = function(){
                ...
                $http.get('/api/connector/connectorx/approve/ssologout?siteaddr=' + siteaddr ).success(function(data){
                    if(data.data)
                    {
            ...
            vm.chpasswd = function(){
                $window.location.href= '/#/connector/chpasswd';
            };
            ...
            // get user
            $http.get('/api/connector/connectorx/approve/sso/userinfo').success(function(data){
                vm.user = data;
            });
