(function(){
    ...
    angular
        .module('openc3')
        .controller('ConnectorServiceAnalysisController', ConnectorServiceAnalysisController);

        function ConnectorServiceAnalysisController($rootScope, $scope,$injector, $window, $http, $state) {
