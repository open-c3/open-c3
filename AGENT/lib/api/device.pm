...
any '/device/detail/:type/:subtype/:treeid/:uuid' => sub {
    ...
    if( -f $ingestionmysqlfile && -f "/data/open-c3-data/device/curr/auth/mysql.auth/$user" )
    {
    ...
    if( -f $ingestionredisfile && -f "/data/open-c3-data/device/curr/auth/redis.auth/$user" )
    {
    ...
    if( -f $ingestionmongodbfile && -f "/data/open-c3-data/device/curr/auth/mongodb.auth/$user" )
    {
    ...
    for my $r ( @re )
    {
        ...
        if( $showmysqlauth )
        {
            ...
            my $mysqlpath = '/data/open-c3-data/device/curr/auth/mysql';
        ...
        if( $showredisauth )
        {
            ...
            my $redispath = '/data/open-c3-data/device/curr/auth/redis';
        ...
        if( $showmongodbauth )
        {
            ...
            my $mongodbpath = '/data/open-c3-data/device/curr/auth/mongodb';
